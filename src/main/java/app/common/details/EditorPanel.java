...
public abstract class EditorPanel<TModel extends IHaveIdentifier,
                                  TItemFactory extends ItemFactory<TModel>> extends JPanel implements
    ...
    public EditorPanel(ItemFactoryProvider<TModel, TItemFactory> itemFactoryProvider,
